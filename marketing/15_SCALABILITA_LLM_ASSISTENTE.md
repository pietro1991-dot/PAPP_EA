...
3. **Quote per piano** (cost-control + upsell):
   - Starter = N domande/giorno · Pro = di più · Elite = priorità + nessun limite pratico.
...
| Cresci (decine/centinaia di attivi) | **Quote per piano** (Starter/Pro/Elite) + cache aggressiva. Valuta **Claude Haiku** per qualità. |
